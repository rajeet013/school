...
const About = () => {
  return (
    <div className="bg-white px-16 py-20">
      <div className="flex gap-20 items-start max-w-6xl mx-auto">
        
        {/* Left: Icon + Title */}
        <div className="flex items-center gap-3 min-w-[250px]">
          <Image src="/box.png" alt="pencil box" width={50} height={50} />
          <h2 className="text-2xl font-bold text-black">About Our School</h2>
        </div>
